  ...
  return (
    <>
      <div className={joinClassNames(styles.arrows, 'fc-row')}>
        <div className={joinClassNames(styles.arrows__arrow, styles['arrow--left'], 'fc-row', 'hover')} onClick={() => scroll(true)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
            <path d="M13.293 6.293 7.586 12l5.707 5.707 1.414-1.414L10.414 12l4.293-4.293z"></path>
          </svg>
        </div>
        <div className={joinClassNames(styles.arrows__arrow, styles['arrow--right'], 'fc-row', 'hover')} onClick={() => scroll(false)}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
